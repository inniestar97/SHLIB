...
public:
	...
	std::string getCurrent_date() const; // 현재 날짜
	int getDiff_date(std::string comp) const;	// 현재날짜 - 기준날짜  /*comp 예시 : "20211023"*/
	std::string getAfter_date(int day) const;	// 현재날짜로부터 day일 후 날짜
